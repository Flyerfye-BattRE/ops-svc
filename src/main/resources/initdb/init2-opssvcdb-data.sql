...
INSERT INTO OpsSvcSchema.OrderSectors (order_sector_id, order_sector) VALUES
(1, 'Personal'),
(2, 'Business'),
(3, 'Corporation'),
(4, 'Government'),
...
INSERT INTO OpsSvcSchema.OrderTypes (order_type_id, order_type) VALUES
(1, 'Intake'),
(2, 'Output'),
(3, 'Demo');

-- Insert statements for the "BatteryStatus" table
INSERT INTO OpsSvcSchema.BatteryStatus (battery_status_id, status) VALUES
(1, 'Intake'),
(2, 'Rejected'),
(3, 'Testing'),
(4, 'Refurb'),
...
INSERT INTO OpsSvcSchema.CustomerData (customer_id, contact_name, email, phone, address, loyalty_id) VALUES
