...
public enum ProcessOrderStatusEnum {
  ...
  OPSSVC_CREATE_RECORD_ERR(
      2, "OPSSVC_CREATE_RECORD_ERR", ProcessOrderStatus.OPSSVC_CREATE_RECORD_ERR),
  STORAGESVC_STORE_BATTERIES_ERR(
      3, "STORAGESVC_STORE_BATTERIES_ERR", ProcessOrderStatus.STORAGESVC_STORE_BATTERIES_ERR),
